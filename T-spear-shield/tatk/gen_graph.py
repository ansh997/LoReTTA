...
# df = pd.read_csv('/home/t2/TGN_adv/tgl-main/wiki_poison/edges.csv')
...
# np.savez(f'{scratch_location}/tspear/DATA/{args.data}/ext_full.npz',
#         indptr=ext_full_indptr,
#         indices=ext_full_indices,
#         ts=ext_full_ts,
#         eid=ext_full_eid)

# have to convert each np arrat to object type
np.savez(f'{scratch_location}/tspear/DATA/{args.data}/ext_full.npz', 
...
with open(f'{scratch_location}/tspear/DATA/{args.data}/ext_full.pkl', 'wb') as f:
    pickle.dump(g, f)
    print(f'dumped at {scratch_location}/tspear/DATA/{args.data}/ext_full.pkl')
