...
class TemporalAttack:
    ...
    def attack(self, orig_node_feats, orig_edge_feats, orig_g, orig_df, ptb_rate, args, seed=0, **kwargs):
        ...
        print('Only Training Data is used for attack')
            ...
            for i_rows, rows in x_df.groupby(x_df.index // args.batch_size):
                if i_rows > 0:
                    ...
                    if edge_feats is not None:
                        ...
                        ptb_edge_feats_batch = np.round(kde.sample(num_ptb_batch), 4)  #  they are generating edge features from a kernel density estimator
