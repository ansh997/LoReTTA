...
try:
    from .sampler_core import ParallelSampler, TemporalGraphBlock  # preferred package import
except ModuleNotFoundError:
    # Fallback for setups where extension is built as top-level "sampler_core".
