...
from utils.load_configs_wandb import get_node_classification_args_wandb
...
if __name__ == "__main__":
    ...
    # get arguments
    args = get_node_classification_args_wandb() # changed to wandb
    
    # ==============================
    # Hyperparameter Sweep Configuration
    # ==============================
    # print()
    sweep_configuration = {'method': 'bayes', # maybe change method too
                        'name': f'{args.dataset_name}_{args.optimizer}_{args.sampling_upto}',
                        'metric': {'goal': 'maximize', 
                                    'name': f'test auc_{args.dataset_name}_{args.sampling_upto}'}, # TODO: change here.                        
    ...
    # add sweep id
    # generate_id = f'{sampling_upto:.0f}_{time.strftime("%Y%m%d_%H_%M_%S", time.localtime())}'
    sweep_id = wandb.sweep(sweep=sweep_configuration, project=f'AdvAttack_Node_CLF')
    ...
    def main(args=args):
        ...
        for run in range(args.num_runs):
            ...
            args.save_model_name = f'node_classification_{args.model_name}_seed{args.seed}_lr_{lr}'
            ...
            load_model_folder = f"/scratch/{getpass.getuser()}/saved_models/{args.model_name}/{args.dataset_name}/{args.save_model_name}/"
            ...
            optimizer = create_optimizer(model=model[1], optimizer_name=args.optimizer, learning_rate=lr, weight_decay=args.weight_decay)
            ...
            save_model_folder = f"/scratch/{getpass.getuser()}/saved_wandb_models/{args.model_name}/{args.dataset_name}/sample_{args.sampling_upto}/{args.save_model_name}/"
            ...
            for epoch in range(args.num_epochs):
                ...
                # ======================================= wandb logging =====================================
                wandb_log[f'train loss_{args.dataset_name}_{args.sampling_upto}'] = train_total_loss
                wandb_log[f'val loss_{args.dataset_name}_{args.sampling_upto}'] = val_total_loss
                wandb_log[f'train auc_{args.dataset_name}_{args.sampling_upto}'] = train_metrics['roc_auc']
                wandb_log[f'val auc_{args.dataset_name}_{args.sampling_upto}'] = val_metrics['roc_auc']
                wandb.log(wandb_log)
                # ==========================================================================================
            ...
            # wandb logging test
            wandb_log[f'test loss_{args.dataset_name}_{args.sampling_upto}'] = test_total_loss
            wandb_log[f'test auc_{args.dataset_name}_{args.sampling_upto}'] = test_metrics['roc_auc']
