...
# --------------------------------------------------------------------------- #
# Helper to append results to CSV                                             #
# --------------------------------------------------------------------------- #
# --------------------------------------------------------------------------- #
# Helper to append results to CSV                                             #
# --------------------------------------------------------------------------- #
def _append_to_csv(
    ...
    """Log class-wise precision/recall for this run."""
...
def print_anoedge_auc_time(base_path: str, dataset_name: str, algorithm: str) -> None:
    ...
    # --- append results to CSV (using Youden numbers) ----------------------- #
    _append_to_csv(dataset_name,algorithm ,tn_y, fp_y, fn_y, tp_y)

# --------------------------------------------------------------------------- #
# Simple AnoGraph evaluation (unchanged)                                      #
# --------------------------------------------------------------------------- #
