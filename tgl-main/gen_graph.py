...
df = pd.read_csv(f'{data_dir}/{args.data}/edges.csv')
...
np.savez('{}/{}/ext_full.npz'.format(data_dir, args.data), indptr=ext_full_indptr, indices=ext_full_indices, ts=ext_full_ts, eid=ext_full_eid)
