...
df = pd.read_csv(f'{save_location}/modified_{args.data}_{args.ss}_sparsified_{args.upto}.csv')
...
print(f'saving at {save_location}/modified_{args.data}_{args.ss}_sparsified_{args.upto}_ext_full.npz')
# np.savez('/raid/t2/TGN_adv/tspear/DATA/{}/int_train.npz'.format(args.data), indptr=int_train_indptr, indices=int_train_indices, ts=int_train_ts, eid=int_train_eid)
# np.savez('/raid/t2/TGN_adv/tspear/DATA/{}/int_full.npz'.format(args.data), indptr=int_full_indptr, indices=int_full_indices, ts=int_full_ts, eid=int_full_eid)
# np.savez('/raid/t2/TGN_adv/tspear/DATA/{}/ext_full.npz'.format(args.data), indptr=ext_full_indptr, indices=ext_full_indices, ts=ext_full_ts, eid=ext_full_eid)

np.savez(f'{save_location}/modified_{args.data}_{args.ss}_sparsified_{args.upto}_ext_full.npz', indptr=ext_full_indptr, indices=ext_full_indices, ts=ext_full_ts, eid=ext_full_eid)

print(f'Done saving at {save_location}/modified_{args.data}_{args.ss}_sparsified_{args.upto}_ext_full.npz')

# np.savez('./wiki_sparse/int_train.npz', indptr=int_train_indptr, indices=int_train_indices, ts=int_train_ts, eid=int_train_eid)
# np.savez('./wiki_sparse/int_full.npz', indptr=int_full_indptr, indices=int_full_indices, ts=int_full_ts, eid=int_full_eid)
# np.savez('./wiki_poison/ext_full.npz', indptr=ext_full_indptr, indices=ext_full_indices, ts=ext_full_ts, eid=ext_full_eid)